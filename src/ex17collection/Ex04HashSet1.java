...
/*
 ...
 -객체의 중복저장을 기본적으로 허용하지 않는다.
 	단, 기본클래스가 아닌 새롭게 정의한 클래스라면 hashCode,equals메소드를
 	적절히 오버라이딩 해야한다.
...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(set.add(teacher2) ? "성공" : "실패");//성공 => Person 클래스에서 오버라이딩한 부분때문에 현재는 실패하고 객체수가 5개로 나옴
		...
		while(itr.hasNext()) {
			...
			if(object instanceof String) {
				...
				System.out.println("Data타입:"+object);
			}
