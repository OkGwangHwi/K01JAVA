...
class Computer{
	...
	public void calculateFunc() {//public 대신에 protected를 써도 가능
		keyboardTouch();//호출순서 1번
		calculate();//호출순서 2번 >> 1,2번이 순서대로 나오도록 캡슐화
	}
	/*
...
class NotebookComputer extends Computer{
	...
	public NotebookComputer(String name,int initCharge) {
		super(name);//super는 생략가능한데 생략을 하려면 19번:생성자도 없어야함!!
		battary = initCharge;
	}
	//배터리 충전을 표현
...
class TableNotebook extends NotebookComputer{
	...
	String regisPencil; //테블릿을 사용하기 위한 펜슬
