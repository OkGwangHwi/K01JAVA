...
/*
 ...
 오버로딩 : 함수명은 같으나 매개변수의 갯수,타입,순서가 다른경우를
 		말한다. 즉, 서로 다른 함수이므로 상속받은
...
class A{
	public void rideMethod() {
		System.out.println("A의 ridedMethod");
	}
...
///////////////////////////////////////////////////////////
		...
		/*
		 ...
		 부모객체를 참조하는것은 불가능하다.
		 */
		//B refId2 = refId1;(refId1 은 A 값을 가지고 있기 때문에 자식인 B,C는 부모객체 참조 X)
		//C refId3 = refId1;
