...
/*
 Calculator 클래스는 해당 java파일에서 외부에 가장 의미있는 클래스로서 public으로 선언되었다
 자바에서는 하나의 class만 public으로 선언하는것이 가능하다.
 public으로 선언된 클래스에서 dafault클래스를 사용하는 형태로 제작되어야한다.
 */
...
public class Calculator {
	...
	/*
	 멤버메소드
	 	: 덧셈 혹은 뺄셈 연산후 결과를 반환하는 메소드로, 각 연산을 위해
	 	해당 dafault 클래스의 멤버메소드를 호출한 후 결과를 반환 받는다.
	 */
	...
	public int subTwoNumber(int n1,int n2) {
		...
		/*
		 ...
		 정보은닉닉되어있는 멤버변수의 출력을 위해 getter()메소드를 호출하고 있다.
		 */
	}
