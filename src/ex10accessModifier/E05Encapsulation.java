...
/*
 ...
 차후에는 별도의 분석 작업 없이 해당 클래스의 메소드만 호출하면 업무는
 오류없이 진행될 것이다.
 */
class EncapsulLogic{
	...
	void doProcess() {
		...
		congratulationPoint.doCongraturationPoint();
...
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		/*
		 업무의 진행순서가 중요하다고 했을때 캡슐화 이전의 코드에서는 개발자가 순서를 지키지
		 않은 상태에서도 실행이 가능한 코드가 된다.
		 */
