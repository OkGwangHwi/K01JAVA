...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 "원"은 숫자가 아니므로 NumberFormatExceptiond이 발생된다.
		 */
		String money = "120원";
		//System.out.println("120원:"+Integer.parseInt(money));
		
		/*
		 실수형태의 문자열을 실수로 변경할 때는 parseInt()를 사용할 수 없다. //parseInt는 정수형태로 변환하기 때문
		 위와 똑같은 에러가 발생된다.
		 */
		String floatString = "3.14";
		//System.out.println(Integer.parseInt(floatString));//에러발생 => parseInt는 정수형태로 변환하기 때문
